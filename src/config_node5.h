...
#define RADIOLIB_LORAWAN_JOIN_EUI 0x4D60BCA203E49C21ULL

#undef RADIOLIB_LORAWAN_DEV_EUI
#define RADIOLIB_LORAWAN_DEV_EUI  0xAC02BCC594A74E74ULL

// AppKey – MSB first
#ifndef RADIOLIB_LORAWAN_APP_KEY
  #define RADIOLIB_LORAWAN_APP_KEY   0x8B,0x6A,0xF9,0x0B,0x8E,0x74,0x0F,0x25,0x30,0x7F,0x10,0xEA,0xFA,0x64,0x26,0x7B
#endif

// NwkKey – if your network key is the same as AppKey, you can copy it here
#ifndef RADIOLIB_LORAWAN_NWK_KEY
  #define RADIOLIB_LORAWAN_NWK_KEY   0x8B,0x6A,0xF9,0x0B,0x8E,0x74,0x0F,0x25,0x30,0x7F,0x10,0xEA,0xFA,0x64,0x26,0x7B
#endif
